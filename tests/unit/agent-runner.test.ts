...
import { createClaudeCodeRunner, createOpenCodeRunner, createRunners } from "../../src/agent-runner.js"
...
describe("createRunners", () => {
  ...
  it("creates multiple runners from config", () => {
    ...
    expect(runners).toHaveProperty("claude")
    expect(runners).toHaveProperty("opencode")
  })
